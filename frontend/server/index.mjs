...
const publicError = (error) => { const code = error?.code || "AI_INVALID_RESPONSE"; return { code, message: code === "INVALID_REQUEST" ? "Please check your details and try again." : code === "AI_TIMEOUT" ? "The AI service took too long. Please try again." : "The AI service is temporarily unavailable. Please try again." }; };
